...
describe('SegmentHeader', () => {
  describe('encodeSegmentHeader', () => {
    ...
    test('should encode base position correctly', () => {
      const header = encodeSegmentHeader({
        flags: 0,
        segmentId: 1n,
        basePosition: 9876543210987654321n,
      });
      const view = new DataView(header.buffer);
      expect(view.getBigUint64(16, false)).toBe(9876543210987654321n);
    });
  ...
  describe('roundtrip', () => {
    test('should preserve all values through encode/decode cycle', () => {
      const testCases = [
        { flags: 0, segmentId: 0n, basePosition: 0n },
        { flags: 255, segmentId: 1n, basePosition: 1n },
        { flags: 0x55, segmentId: 0xffffffffffffffffn, basePosition: 0xffffffffffffffffn },
        { flags: 0xaa, segmentId: 1234567890123456789n, basePosition: 987654321098765432n },
      ];
