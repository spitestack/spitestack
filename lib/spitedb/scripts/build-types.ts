/**
 * Generates minimal type declarations for the SpiteDB runtime.
 *
 * This creates a spitedb.d.ts file containing only the types needed by
 * generated code (SpiteDB class, StoredEvent, ConcurrencyError, etc.)
 */
...
await Bun.write('./dist/spitedb.d.ts', types);
console.log('Type declarations written to dist/spitedb.d.ts');
